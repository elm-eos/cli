...
exports.command = 'static';
exports.describe = 'Copies and optimizes static files';
...
function build(args) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    glob = util.src(args, 'static', '*');
                    return [4 /*yield*/, globby(glob)];
                case 1:
                    srcPaths = _a.sent();
                    return [4 /*yield*/, Promise.all(srcPaths.map(function (srcPath) {
                            var name = path.relative(util.src(args, 'static'), srcPath);
                            var distPath = util.dist(args, name);
                            console.log({ name: name, distPath: distPath });
